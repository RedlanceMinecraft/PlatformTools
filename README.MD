...
dependencies {
    ...
    implementation "org.redlance.platformtools:accent:4.2.1"
    implementation "org.redlance.platformtools:referer:4.2.1"
    implementation "org.redlance.platformtools:favorites:4.2.1"
    implementation "org.redlance.platformtools:progress:4.2.1"
    implementation "org.redlance.platformtools:webp:4.2.1"

    // For Java 8 (Downgraded version), add classifier:
    // implementation("org.redlance.platformtools:accent:4.2.1:java8")
}
```
...
implementation "org.redlance.platformtools:webp:4.2.1:bundled"

// Bundled Lite — ngengine decoder only, no native binaries
implementation "org.redlance.platformtools:webp:4.2.1:bundled-lite"
```
