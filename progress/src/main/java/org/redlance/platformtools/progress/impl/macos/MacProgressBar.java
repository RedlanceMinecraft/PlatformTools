package org.redlance.platformtools.progress.impl.macos;
...
public final class MacProgressBar implements PlatformProgressBars {
    ...
    public MacProgressBar() {
        this.nsApp = CLIENT.sendProxy("NSApplication", "sharedApplication");
    ...
    public PlatformProgressBar create() throws TooManyProgressBarsException {
        ...
        if (this.container == null) {
            this.container = CLIENT.sendProxy("NSImageView", "alloc");
    ...
    private final class ProgressBar implements PlatformProgressBar {
        ...
        ProgressBar() {
            this.indicator = CLIENT.sendProxy("NSProgressIndicator", "alloc");
